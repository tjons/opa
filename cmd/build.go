...
`,
	...
	buildCommand.Flags().BoolVar(&buildParams.followSymlinks, "follow-symlinks", false, "set whether to follow symlinks when loading files from the directory being built")
